            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col items-center shrink-0">
                  <div
                    className={`flex h-9 w-9 sm:h-10 sm:w-10 shrink-0 items-center justify-center rounded-xl ${iconBg}`}
                  >
                ...
                <div className="flex-1 min-w-0 pt-0.5">
                  ...
                  <div className="flex items-center flex-wrap gap-x-2 gap-y-1 mt-1.5">
                    ...
                    {article.category && (
                      <span className="text-[11px] sm:text-xs text-slate-400 bg-slate-50 px-2 py-0.5 rounded-full border border-slate-100">
                        {article.category}
                      </span>
                    )}
                    {article.isFeatured && (
                      <span className="text-[11px] sm:text-xs font-medium text-amber-600 bg-amber-50 px-2 py-0.5 rounded-full border border-amber-100 flex items-center gap-1">
